<h1>Projeto Blog Pessoal - Criar o Componente Home</h1>



Vamos criar o nosso primeiro Componente, o **Home**, que será a nossa página inicial. Por enquanto iremos construir um componente simples (como vemos na imagem abaixo) e no decorrer do treinamento iremos aperfeiçoar o nosso componente.

<div align="center"><img src="https://i.imgur.com/bMgF1oE.png" title="source: imgur.com" /></div>
...
Antes de criarmos o Componente **Home**, vamos criar a pasta **pages**. A pasta **pages** será utilizada para criarmos todos os nossos componentes estáticos, ou seja, componentes que não será modificados dinamicamente durante a sua renderização e sempre terão o mesmo conteúdo. Outros exemplos de Componentes Estáticos são o Menu e o Rodapé.
...
1. O nome da pasta será **home** (letras minúsculas), como mostra a figura abaixo. Após digitar o nome da pasta, pressione a tecla **enter** do seu teclado para concluir.

<div align="center"><img src="https://i.imgur.com/2fiPRCw.png" title="source: imgur.com" /></div>

Na sequência, vamos criar o arquivo **Home.tsx**, dentro da pasta **home**:
...
1. Clique com o botão direito do mouse sobre a pasta **home**, que foi criada dentro da pasta **pages**, como mostra a figura abaixo, e clique na opção **New File** (Novo Arquivo).

<div align="center"><img src="https://i.imgur.com/9lEKo3x.png" title="source: imgur.com" /></div>

2. O nome do arquivo será **Home.tsx**, como mostra a figura abaixo. Após digitar o nome do arquivo, pressione a tecla **enter** do seu teclado para concluir.
...
Após alterações no arquivo index.html, observe que o t**ítulo da página e o favicon** (ícone ao lado do título) no Navegador foram atualizados, como mostra a imagem abaixo:
