...
Antes de criarmos o Componente **Home**, vamos criar a pasta **pages**. A pasta **pages** será utilizada para criarmos todos os nossos componentes que serão renderizados na tela.
