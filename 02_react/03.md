...
1. Abra no **VSCode** a pasta **react**, clicando com o botão direito do mouse sobre a pasta, e na sequência, clique na opção **Abrir com Code**.
...
4. Será aberta a tela do **Power Shell** na parte inferior da janela do VSCode.
...
6. Através do menu **File 🡪 Open Folder...** (Abrir Pasta...), vamos abrir a pasta **blogpessoal**, criada na pasta **react**, anteriormente criada na Área de Trabalho.

<div align="center"><img src="https://i.imgur.com/l9KGMpo.png" title="source: imgur.com" /></div>

8. Selecione a pasta **blogpessoal**, que foi criada dentro da pasta **react** e clique no botão **Selecionar pasta**.
...
10. De volta ao Terminal, digite o comando abaixo instalar todos os pacotes necessários, para executar o React, que foram definidos pelo Vite:

```bash
yarn
```

11. Após a instalação será exibida uma mensagem semelhante a imagem abaixo:

<div align="center"><img src="https://i.imgur.com/HOA8Aod.png" title="source: imgur.com" /></div>

12. Caso seja exibida a mensagem abaixo, significa que você está tentando executar o comando na pasta errada. Verifique se a pasta está correta e tente novamente.
...
15. Pressione a tecla **h** do seu teclado. Observe que será aberto um menu com alguns atalhos (Shortcuts) do Vite, como mostra a imagem abaixo:
...
16. Pressione a tecla **o** do seu teclado para abrir o Projeto no Navegador
