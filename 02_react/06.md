...
Vamos criar dois novos Componentes no Projeto Blog Pessoal, o **Navbar** e o **Footer**, que serão inseridos na nossa página inicial. Além disso, vamos aperfeiçoar o nosso componente **Home**, estilizando com o **Tailwind**.

<br />

<h2>👣 Passo 01 - Criar a pasta Components</h2>



Antes de criarmos os Componentes **Navbar e Footer**, vamos criar a pasta **components**. A pasta **components**, como o próprio nome também diz, é  responsável por armazenar todos os componentes do projeto, porém, existe uma pequena diferença em relação a pasta **pages**: os componentes localizados na pasta components devem ser  “globais”, ou seja, utilizados em duas ou mais páginas dentro da aplicação.

1. Na pasta **src**, clique com o botão direito do mouse e clique na opção **New Folder** (Nova Pasta).

<div align="center"><img src="https://i.imgur.com/Jv3Ncu4.png" title="source: imgur.com" /></div>
...
Na sequência, vamos criar o arquivo **Navbar.tsx**, dentro da pasta **navbar**:
...
1. Clique com o botão direito do mouse sobre a pasta **navbar**, que foi criada dentro da pasta **components**, como mostra a figura abaixo, e clique na opção **New File** (Novo Arquivo).

2. O nome do arquivo será **Navbar.tsx**, como mostra a figura abaixo. Após digitar o nome do arquivo, pressione a tecla **enter** do seu teclado para concluir.
...
```bash
npm i --save @phosphor-icons/react
```
...
1. Clique com o botão direito do mouse sobre a pasta **footer**, que foi criada dentro da pasta **components**, como mostra a figura abaixo, e clique na opção **New File** (Novo Arquivo).

2. O nome do arquivo será **Footer.tsx**, como mostra a figura abaixo. Após digitar o nome do arquivo, pressione a tecla **enter** do seu teclado para concluir.
