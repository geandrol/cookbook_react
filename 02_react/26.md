...
Nosso formulário terá a aparência das imagens abaixo, já que ele será usada tanto no Cadastro de novas Postagens, quanto na Edição de Postagens já criadas. Em suma, este componente irá ter 

ALTERAR IMAGEM E DESCRIÇÃO
