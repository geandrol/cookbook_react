...
**Linhas 42 a 44:** Adicionamos o componente Link ao componente Login. Ele se comporta como um botão, sendo necessário clicar sobre ele para disparar sua ação. Podemos observar que o Link recebe uma **props** chamada **to**, ela indica a rota que a pessoa usuária será redirecionada - no nosso caso será a de cadastro.

**Linha 43:** O Componente Link pode envolver outros conteúdos, como **tags, componentes e textos.** Aqui colocamos um texto indicativo a pessoa usuária.
