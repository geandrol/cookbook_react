...
- **ReactNode**: nada mais é que uma **tipagem especial do React**, que **representa qualquer coisa que pode ser renderizada** como um elemento na árvore de componentes do React;
